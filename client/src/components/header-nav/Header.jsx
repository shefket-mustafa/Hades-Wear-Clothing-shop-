...
export default function Header({ cartLength, onToggle }) {
  ...
  const handleLogout = () => {
    dispatch(logout());
    dispatch(showPopUp("You have logged out!"));
        ...
        <div className="menu-item">
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-accessoaries">
              ...
              <Link to="/catalog/womens-accessoaries-sunglasses">
                WOMENS SUNGLASSES
              </Link>
        ...
        <div className="menu-item">
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-mens-acessoaries">
              ...
              <Link to="/catalog/mens-accessoaries-sunglasses">
                MENS SUNGLASSES
              </Link>
